...
let botonNuevoJuegoDesaparecido = document.getElementById("botao-novo-jogo").style.display = "none"
let botaoSairDesaparecer = document.getElementById("botao-sair").style.display = "none"
let divAgregarPalavra = document.getElementById("adicionar-palavra").style.display = 'none';
let botaoNovoJogo = document.getElementById("botao-novo-jogo");
...
// captura o id "botao-guardar", salva a palavra adicionada
document.getElementById("botao-salvar").onclick = () => {
  salvarPalavra();
...
function iniciarJogo() {
  ...
  document.getElementById("botao-novo-jogo").style.display = "block"
